...
<body>
    <div class="container py-3">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                <label for="juros" class="form-label">Insira uma taxa de juros: </label>
                <input type="number" id="taxa" name="taxa" class="form-control" required="">
            </div>
            <div class="mb-3">
                <label for="periodo" class="form-label">Insira um periodo: </label>
        ...
        <?php
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                echo "O total de juros a pagar será de: R$ $resultado";
            }
        ?>
